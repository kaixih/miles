...
# No explicit register_cpu_ci: tests/fast/**/*.py are implicitly registered to
# the stage-a-cpu suite (see tests/ci/ci_register.collect_tests), and the
# default-form call is rejected by the AC-9 meta-test.
