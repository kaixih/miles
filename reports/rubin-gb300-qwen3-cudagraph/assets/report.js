...
const actorNames={forward:"Forward",backward:"Backward",recompute:"Recompute",moe:"MoE fwd.",communication:actorInput.measurement_basis==="cpu_annotation_elapsed_ms"?"Comm. enqueue":"Comm.",optimizer:"Optimizer"};
function actorPanel(){
